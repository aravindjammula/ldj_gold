  ...
  return (
    <div className="group relative bg-white transition-all duration-300 hover:shadow-xl hover:-translate-y-1 rounded-sm border border-gray-100">
      ...
      <div className="relative w-full aspect-[3/4] overflow-hidden bg-gray-50">
        ...
        <button className="absolute top-2 right-2 z-20 p-2 rounded-full bg-white/0 text-white hover:bg-white hover:text-red-500 transition-all duration-300 opacity-0 group-hover:opacity-100">
          <Heart size={18} />
        </button>
        ...
        <div className="absolute inset-x-0 bottom-4 flex justify-center gap-2 z-20 opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
          ...
          <button className="bg-white text-gray-800 p-3 rounded-full shadow-lg hover:bg-ldj-gold hover:text-white transition-colors" title="Quick View">
            <Eye size={18} />
          </button>
          
          <button className="bg-ldj-dark text-white p-3 rounded-full shadow-lg hover:bg-ldj-gold transition-colors" title="Add to Cart">
            <ShoppingBag size={18} />
          </button>
