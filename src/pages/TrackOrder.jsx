      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <input
            ...
            aria-label="Enter your Jewelry Tracking ID" /* Added for Screen Readers */
            className="flex-grow border border-black p-4 text-xs tracking-[0.2em] focus:outline-none focus:border-ldj-gold uppercase"
          />
          <button
            type="submit" /* Ensures the Enter key works to submit */
            className="bg-black text-white px-10 py-4 text-xs font-bold uppercase tracking-widest hover:bg-ldj-gold transition-all"
          >
            Track Shipment
          </button>
        </div>
